      ...
      {showPopUp && (
        <>
          ...
          <section className="pointer-events-auto fixed flex h-screen w-screen items-center justify-center">
            <div className="absolute  flex w-fit flex-col items-center gap-5 rounded-xl bg-white px-10 py-5 dark:bg-gray-900 min-[0px]:max-[768px]:gap-4 min-[0px]:max-[640px]:flex-col">
